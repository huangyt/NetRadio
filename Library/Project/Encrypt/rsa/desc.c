...
*/
void DESX_CBCInit (DESX_CBC_CTX *context,
...
static void Unpack (unsigned char *into,
					UINT4 *outof)
{
...
static void DESKey (UINT4 subkeys[32],
					unsigned char key[8],
					int encrypt)
{
	UINT4 kn[32];
...
static void CookKey (UINT4 *subkeys,
					 UINT4 *kn,
					 int encrypt)
{
...
static void DESFunction (UINT4 *block,
						 UINT4 *subkeys)
{
